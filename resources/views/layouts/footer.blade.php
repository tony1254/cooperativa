...
<footer class="page-footer center-on-small-only mdb-color lighten-3">
    ...
    <div class="container">
        <div class="row my-4">
            ...
            <!--First column-->
            <div class="col-md-4 col-lg-4 wow fadeIn">
                <h5 class="title mb-4 font-bold wow fadeInDown">Footer Content</h5>
                <p class=" " >Here you can use rows and columns here to organize your footer content.</p>
                <p class=" ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, error amet numquam iure provident
            ...
            <div class="col-md-4 col-lg-3 wow fadeIn">
                <h5 class="title mb-4 font-bold wow fadeInDown">Adress</h5>
                <!--Info-->
            ...
            <div class="col-md-2 col-lg-2 text-center wow fadeIn">
                <h5 class="title mb-4 font-bold wow fadeInDown">Follow Us</h5>
                <!--Social buttons-->
